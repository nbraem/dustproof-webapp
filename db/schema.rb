...
ActiveRecord::Schema.define(version: 20160430220638) do
  ...
  create_table "measurements", force: :cascade do |t|
    ...
    t.integer  "p2_count"
    t.float    "pm25_ratio"
    t.integer  "p1_concentration"
    t.integer  "p1_concentration_filtered"
    t.integer  "p2_concentration"
    t.integer  "p2_concentration_filtered"
  end
